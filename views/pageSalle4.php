...
<div id="menudyna3">
			<ul>
				...
				<li style = "background-color : black"> <a style = "color : white"  href="../controlleurs/pageSallecontrolleur4.php">Avis</a> </br>
			</ul> 	

</div>
<div class="contenusalle4"> aaaaaaaaaaaaaaaaaaaaaaaaaaaa</div>
