...
<div id="formulaire">
	<form enctype = "multipart/form-data" class ="form2" onsubmit = "return grosseVerif()"  name = "formIn" method="post" action="index.php?page=formulairecontrolleur">
		<ul>
			...
			<li>
				<div class="conditions"><input  class = "textbox" type="checkbox" name="conditions" required value=""/><span>J'accepte les <a class = "cgu" href="index.php?page=charteForumcontrolleur">conditions d'utilisation</a> </span></div>
			</li>				
			<li>
