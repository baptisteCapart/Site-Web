...
<div id="bloc">
		...
		<div id="formulaire">
		<form enctype = "multipart/form-data" name = "formA" onsubmit = "return checkExt(formA,photogroupe);" class ="form2" method="post" action="index.php?page=formulairegroupecontrolleur">
			<ul>
				<li>
